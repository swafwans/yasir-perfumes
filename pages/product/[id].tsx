...
import { PlusIcon, MinusIcon } from '@/src/components/icons';
...
const ProductPage: React.FC = () => {
  ...
  const product = getProductById(parseInt(id as string || '', 10));

  if (!product) {
    return <div className="container mx-auto px-6 py-20 text-center">Loading product...</div>;
  }
