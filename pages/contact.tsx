...
import { PhoneIcon, MailIcon, HeadsetIcon, MapPinIcon, FacebookIcon, InstagramIcon, YouTubeIcon } from '@/src/components/icons';
        ...
        <div className="bg-black text-gray-300">
            <section className="relative py-20 bg-gray-900">
                ...
                <div className="relative container mx-auto px-6 text-center text-white z-10">
                    ...
                    <p className="text-lg text-gray-400">HOME / CONTACT US</p>
                </div>
            </section>
