      ...
      <div className="container mx-auto px-6 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">
          ...
          <div>
            ...
            <div className="flex flex-col space-y-2 text-sm">
                ...
                <Link href="/shopping" className="hover:text-white transition-colors duration-300">Shop</Link>
                <Link href="/favorites" className="hover:text-white transition-colors duration-300">Favorites</Link>
            </div>
          </div>
        ...
        <div className="text-center mt-12 border-t border-gray-800 pt-8">
            <div className="flex justify-center space-x-6 mb-4">
                <Link href="/terms-conditions" className="text-xs hover:text-white transition-colors duration-300">Terms & Conditions</Link>
                <Link href="/privacy-policy" className="text-xs hover:text-white transition-colors duration-300">Privacy & Policies</Link>
                <Link href="/refund-cancellation" className="text-xs hover:text-white transition-colors duration-300">Refund & Cancellation</Link>
            </div>
            ...
            <Link href="/admin" className="text-xs text-gray-700 hover:text-gray-300 transition-colors mt-2 inline-block">Admin</Link>
        </div>
      </div>
    </footer>
  );
