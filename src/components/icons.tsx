...
export const Logo: React.FC<{className?: string, textClassName?: string, iconSize?: number}> = ({className, textClassName = 'text-2xl', iconSize = 30}) => {
    ...
    return (
        <div className={`flex items-center text-white ${className}`}>
            <svg xmlns="http://www.w3.org/2000/svg" width={iconSize} height={iconSize} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="mr-2 text-amber-500 shrink-0">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path>
                <path d="M14.5 9A2.5 2.5 0 0 0 12 6.5 2.5 2.5 0 0 0 9.5 9c0 1.4 1.12 2.5 2.5 2.5s2.5-1.1 2.5-2.5z"></path>
                <path d="M12 12v4"></path>
            </svg>
            <span className={`${textClassName} font-bold tracking-wider whitespace-nowrap`} style={{fontFamily: 'serif'}}>
                YASIR PERFUMES
            </span>
        </div>
    );
...
export const HeartIcon: React.FC<IconProps & { isFilled?: boolean }> = ({ className, isFilled, style }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} style={style} fill={isFilled ? 'currentColor' : 'none'} viewBox="0 0 24 24" stroke="currentColor">
...
export const GiftIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 8v13m0-13V6a2 2 0 112 2h-2zm0 0V6a2 2 0 10-2 2h2zm0 0h10.5m-10.5-4H1.5" />
...
export const BriefcaseIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} style={style} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 13.255A23.031 23.031 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
  </svg>
);
...
export const HeadsetIcon: React.FC<IconProps> = ({ className, style }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className} style={style}>
